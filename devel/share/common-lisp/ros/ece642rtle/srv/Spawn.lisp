...
(cl:defmethod cl:initialize-instance :after ((m <Spawn-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Spawn-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ece642rtle-srv:<Spawn-request> is deprecated: use ece642rtle-srv:Spawn-request instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Spawn-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ece642rtle-srv:x-val is deprecated.  Use ece642rtle-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Spawn-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ece642rtle-srv:y-val is deprecated.  Use ece642rtle-srv:y instead.")
  (y m))

(cl:ensure-generic-function 'theta-val :lambda-list '(m))
(cl:defmethod theta-val ((m <Spawn-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ece642rtle-srv:theta-val is deprecated.  Use ece642rtle-srv:theta instead.")
  (theta m))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Spawn-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ece642rtle-srv:name-val is deprecated.  Use ece642rtle-srv:name instead.")
  (name m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Spawn-request>)))
  ...
  (cl:format cl:nil "float32 x~%float32 y~%float32 theta~%string name # Optional.  A unique name will be created and returned if this is empty~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Spawn-request)))
  "Returns full string definition for message of type 'Spawn-request"
  (cl:format cl:nil "float32 x~%float32 y~%float32 theta~%string name # Optional.  A unique name will be created and returned if this is empty~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <Spawn-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Spawn-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ece642rtle-srv:<Spawn-response> is deprecated: use ece642rtle-srv:Spawn-response instead.")))
